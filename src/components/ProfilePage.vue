...
.welcome-message {
  background-image: url('@/assets/welcomeMessage.svg');
  width: 534px;
  height: 286px;
  margin-top: 50%;
  margin-left: 2%; 
...
.start-button {
  background-image: url('@/assets/startButton.svg');
...
.start-button:hover {
  background: url('@/assets/startButtonShadow.svg') no-repeat center center;
  color: transparent;
  width: 199px;
  height: 53.7149px;
  border: none;
